...
export default async function EventIssuesPage({ params }: EventIssuesPageProps) {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      {/* Header Section */}
      <section className="bg-gradient-to-r from-orange-500 to-red-600 py-8">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-4 mb-4">
            <Button asChild variant="outline" size="sm" className="bg-white text-orange-600 hover:bg-gray-100">
